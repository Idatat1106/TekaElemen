...
def main():
    ...
    ElemenLists=["Hydrogen","Helium","Lithium","Carbon","Nitrogen","Oxygen","Fluorine","Neon","Aluminium","Silicon","Sulfur","Chlorine","Krypton"]
    clue1=["Water Constituem","Balloon","Battery","The most organic compount","Most needed by plant","Most needed by human",
            "toothpaste","To protect bulb elemen from burn","Conduct heat efficiently","Glass","firecrackers","we drink in tap water","feared superman"]
